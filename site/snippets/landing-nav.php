...
?>
<nav id="mainNav" class="fixed top-0 w-full px-6 lg:px-10 pt-4 pb-2 z-100 flex justify-between items-center min-h-16 bg-linear-to-b from-black/50 to-transparent transition-all duration-300 ease-in-out">
